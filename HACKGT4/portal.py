...
OAUTH_TOKEN = 'YOUR_OAUTH_TOKEN_SECRET'
...
def getTimeline(screenName, tweetCount = 200, excludeReplies = False):
    ...
    if tweetCount <= 5:
        ...
        fp = codecs.open('.\Results\\'+currentTime()+' (TIMELINE).txt', 'w', "utf-8")
        for result in results:
